...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('attachments_attachment', 'file_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attachment.file_name'
        db.delete_column('attachments_attachment', 'file_name')
